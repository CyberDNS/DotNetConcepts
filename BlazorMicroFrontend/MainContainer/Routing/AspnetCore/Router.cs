...
namespace Microsoft.AspNetCore.Components.Routing
{
    ...
    /// </summary>
    public class AspnetCoreRouter : IComponent, IHandleAfterRender, IDisposable
    {
        ...
        ILogger<AspnetCoreRouter> _logger;
        ...
        {
            _logger = LoggerFactory.CreateLogger<AspnetCoreRouter>();
        ...
        public async Task SetParametersAsync(ParameterView parameters)
        {
            ...
            if (AppAssembly == null)
            {
                throw new InvalidOperationException($"The {nameof(AspnetCoreRouter)} component requires a value for the parameter {nameof(AppAssembly)}.");
            }
            ...
            if (Found == null)
            {
                throw new InvalidOperationException($"The {nameof(AspnetCoreRouter)} component requires a value for the parameter {nameof(Found)}.");
            }
            ...
            if (NotFound == null)
            {
                throw new InvalidOperationException($"The {nameof(AspnetCoreRouter)} component requires a value for the parameter {nameof(NotFound)}.");
            }
